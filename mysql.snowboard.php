...
// costruzione elenco snowboard (checkbox): per ogni riga selezionata
// con nome comune "selection"
$elenco="";
while ($row = mysqli_fetch_array($resultQ))
  $elenco.="<tr><td><input type=\"checkbox\" name=\"selection[]\" value=\"{$row['tipoSnowboard']}\" />{$row['tipoSnowboard']}</td>\n
           <td style=\" text-align:center; \">{$row['descr']}</td>\n
           <td style=\" text-align:center; \">&euro; {$row['costoSnowboard']}</td>\n
           <td style=\" text-align:center; \"><input type=\"number\" name=\"quantita{$row['tipoSnowboard']}\" min=\"1\" max=\"10\"></td>\n</tr>\n";
...
<head>
<title>sessione con carrello della spesa per snowboard</title>
...
<h2>SCI</h2>
<p><?php echo $_SESSION['userName']?>, scegli pure gli snowboard che vuoi:</p>
